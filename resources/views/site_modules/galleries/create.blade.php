...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                {{ html()->form('POST', route('galleries.store'))->id('gallery-form')->attribute('enctype', 'multipart/form-data')->open() }}
                @include('site_modules.galleries.partial.form')
        ...
        $(document).ready(function() {
            $('#gallery_type').change(function() {
                if ($('#gallery_type').val() === 'video') {
                    $(document).find('.image-container').css({
                        "visibility": "hidden",
                        'height': "0"
                    });
